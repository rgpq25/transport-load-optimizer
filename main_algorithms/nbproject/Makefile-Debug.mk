...
${OBJECTDIR}/graspPackingState.o: graspPackingState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graspPackingState.o graspPackingState.cpp

${OBJECTDIR}/graspSolution.o: graspSolution.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graspSolution.o graspSolution.cpp

${OBJECTDIR}/graspUtils.o: graspUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graspUtils.o graspUtils.cpp
